...
void TextureFiltr_Mean_V8_3_sse4_omp(MU16Data& ar_cmmIn, MFData& ar_cmmOut, double pseudo_min, double kfct, int thr_amount)
{
	...
	for (int i = 1; i < thr_amount - 1; ++i) {
		iRowThr[i] = iRowThr[i - 1] + iThrRowMax;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 3 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 5 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 7 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 9 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 11 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 13 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 15 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 17 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 19 * i_thr;
...
#pragma omp parallel for private(pbBrightnessRow, iRow, iPos, iCol,  iCmin , iCmax, puiSumCurr, pHist, pHistAdd, pHistSub, i,d,u32ValueAdd, u32ValueSub)
	for (int i_thr = 0; i_thr < thr_amount; ++i_thr) {
		pbBrightnessRow = pbBrightness + ar_cmmIn.m_i64W * 21 * i_thr;
